...
/*   Updated: 2022/09/07 18:03:48 by jnho             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include <stdlib.h>
...
char	*ft_malloc_split_word(char *str, int rtn_idx, int *str_idx)
{
	int		word_cnt;
	int		str_idx_plus;
	int		rtn_arr_idx;
...
char	**ft_split(char *str, char *charset)
{
	...
	{
		rtn_split[rtn_idx] = ft_malloc_split_word(cpd_str, rtn_idx, &str_idx);
